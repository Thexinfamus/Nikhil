...
TOKEN = '7279800328:AAHnWB8uC4wgN6zNPXrwTWXzRr55oZtWEBg'
...
FORWARD_CHANNEL_ID = -1002190029844
CHANNEL_ID = -1002190029844
error_channel_id = -1002190029844
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: (TELEGRAM CHANNEL USER✅ )*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact admin (ADMIN USER✅)*", parse_mode='Markdown')
    else:
